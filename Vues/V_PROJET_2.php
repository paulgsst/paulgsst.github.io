<div id = "description">
    <p>
        Durant mon stage de 2eme année de BTS SIO SLAM , j'ai été dans une entreprise spécialisée dans la publicité numérique .
    </p>
</div>
<div class='imgMenu'>
...
<div id="descriptionMagasin">
    <p>
        Cette entreprise est située aux Docks à la Joliette à Marseille .
    </p>
    <img src="Images/stage2/les-docks.jpg" id="imgLesDocks" alt="">
    <p>
        Le nom de cette entreprise est Biggie Group 
    </p>
    <img src="Images/stage2/biggiegroup_logo.jpg" id="logoBiggie" alt="">
    <p>
        Durant ce stage on m'a confié des ticket sur différents projet . 
        Ces tickets me demandaient de faire des modifications front-end la plupart du temps
    </p>
    <p>
    ...
    <p>
        ...
        <br>
        Le matin on se réunnissait pour parler de ce que l'on avait fait la veille ,
        <br> si on avait eu des problèmes , si ces dit problèmes ont été résolus 
        <br> et qu'est-ce qu'on allait faire aujourd'hui . 
        <br>
        Ils faisaient souvent des réunions en visions conférences pour parler de l'avancé des projets .
    </p>
</div>